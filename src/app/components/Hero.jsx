  ...
  return (
    <div className='bg-gray-700 h-screen'>
        ...
        <div className='m-30 flex flex-col justify-center gap-8 text-center items-center'>
            ...
            <button onClick= {() => {handlesignin()}}className='bg-teal-300 text-gray-700 shadow-teal-200 shadow-md active:translate-y-1 hover:translate-y-0.5 transition duration-300 font-extrabold text-xl rounded-3xl p-3'><a href='/dashboard'>Start Now</a></button>
        </div>
